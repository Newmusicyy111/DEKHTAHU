...
from StormBeatz.misc import SUDOERS
from StormBeatz.utils.database.memorydatabase import get_video_limit
from StormBeatz.utils.formatters import convert_bytes
...
async def varsFunc(client, message):
    ...
    s_c = f"[Channel](https://t.me/noobxcreator)"
    s_g = f"[Group](https://t.me/noobcreator)"
